...
public class ExtentReportManager implements ITestListener {
    ...
    public void onStart(ITestContext testContext) {
        ...
        if (!includedGroups.isEmpty()) {
            // ✅ FIX 1: Clean group formatting instead of raw List.toString()
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        // ✅ FIX 2: Added missing space before "got"
    ...
    public void onTestFailure(ITestResult result) {
        ...
        // ✅ FIX 3: null check before getMessage() to avoid NullPointerException
    ...
    public void onTestSkipped(ITestResult result) {
        ...
        // ✅ FIX 4: null check retained from your version
        if (result.getThrowable() != null) {
            test.log(Status.INFO, result.getThrowable().getMessage());
        }
    }
